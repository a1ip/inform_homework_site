 ...
 *
 * @param {string} url ID новой страницы (используется в хешах URL)
 * @param {string} content HTML содержание новой страницы
*/
pages.create = function(url, content){
    $(pages.main_div).append('<div id="'+url+'" class="page">'+content+'</div>');
}
